...
/*!
 * check_s10rdds.js
 * s10rdds checks can't run on an AGENT
 */
...
var check = exports.check = function(jobinfo){
    logger.log('error',"check_agent: S10RDDS checks can not run on an AGENT");
    ...
    jobinfo.results.message = 'S10RDDS checks cannot be run on an AGENT';
