...
/*!
 * check_push.js
 * PUSH checks can't run on an AGENT
 */
...
var check = exports.check = function(jobinfo){
    logger.log('error',"check_agent: PUSH checks can not run on an AGENT");
    ...
    jobinfo.results.message = 'PUSH checks cannot be run on an AGENT';
